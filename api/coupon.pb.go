...
func (x *ListCouponForCustomerRequest) GetServiceIds() []string {
	if x != nil {
		return x.ServiceIds
	}
	return nil
...
func (x *ListCouponForCmsRequest) GetServiceIds() []string {
	if x != nil {
		return x.ServiceIds
	}
	return nil
...
func (x *CreateCouponRequest) GetServiceIds() []string {
	if x != nil {
		return x.ServiceIds
	}
	return nil
...
const file_coupon_api_coupon_proto_rawDesc = "" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x10.coupon.SortTypeR\x04type\"\xe5\x02\n" +
	"\x06Reward\x12\x0e\n" +
	...
	"\x03ids\x18\x01 \x03(\x04R\x03ids\"\xc4\x01\n" +
	...
	"\bstore_id\x18\x02 \x01(\tR\astoreId\"U\n" +
	...
	"\vtotal_pages\x18\x03 \x01(\x05R\n" +
	"totalPages\x12>\n" +
	"\arequest\x18\x04 \x01(\v2$.coupon.ListCouponForCustomerRequestR\arequest\"\x90\x02\n" +
	"\x17ListCouponForCmsRequest\x12&\n" +
	"\n" +
	"page_index\x18\x01 \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\tpageIndex\x12$\n" +
	"\tpage_size\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x00R\bpageSize\x125\n" +
	"\fsort_methods\x18\x03 \x03(\v2\x12.coupon.SortMethodR\vsortMethods\x12!\n" +
	"\fcustomer_ids\x18\x04 \x03(\tR\vcustomerIds\x12\x1f\n" +
	"\vservice_ids\x18\x05 \x03(\tR\n" +
	"serviceIds\x12,\n" +
	...
	"\fsort_methods\x18\x04 \x03(\v2\x12.coupon.SortMethodR\vsortMethods\"\xc3\x01\n" +
	"\x14ListProgressResponse\x124\n" +
	"\rprogress_list\x18\x01 \x03(\v2\x0f.coupon.ProressR\fprogressList\x12\x1d\n" +
	"\n" +
	...
	"\vtotal_count\x18\x03 \x01(\x05R\n" +
	"totalCount\x125\n" +
	"\arequest\x18\x04 \x01(\v2\x1b.coupon.ListProgressRequestR\arequest\"\xc0\x02\n" +
	...
	"\x18MILESTONE_TYPE_RECURRING\x10\x022\xf5\x06\n" +
	...
	"\x10ListCouponForCms\x12\x1f.coupon.ListCouponForCmsRequest\x1a .coupon.ListCouponForCmsResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/coupon/cms/list\x12c\n" +
	...
	"\x0fDeleteMileStone\x12\x1e.coupon.DeleteMileStoneRequest\x1a\x16.google.protobuf.Empty\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/coupon/milestone/delete\x12d\n" +
...
var file_coupon_api_coupon_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_coupon_api_coupon_proto_goTypes = []any{
	...
	(*CreateMileStoneRequest_MilestoneReward)(nil), // 35: coupon.CreateMileStoneRequest.MilestoneReward
...
var file_coupon_api_coupon_proto_depIdxs = []int32{
	...
	36, // 4: coupon.StoreCoupon.expired_at:type_name -> google.protobuf.Timestamp
	...
	36, // 9: coupon.CouponUsage.reserved_at:type_name -> google.protobuf.Timestamp
	36, // 10: coupon.CouponUsage.used_at:type_name -> google.protobuf.Timestamp
	7,  // 11: coupon.MilestoneProgress.Milestone:type_name -> coupon.Milestone
	35, // 12: coupon.CreateMileStoneRequest.rewards:type_name -> coupon.CreateMileStoneRequest.MilestoneReward
	...
	10, // 27: coupon.ListProgressResponse.progress_list:type_name -> coupon.Proress
	...
	24, // 33: coupon.Coupon.ListCouponForCustomer:input_type -> coupon.ListCouponForCustomerRequest
	26, // 34: coupon.Coupon.ListCouponForCms:input_type -> coupon.ListCouponForCmsRequest
	30, // 35: coupon.Coupon.ListCurrency:input_type -> coupon.ListCurrencyRequest
	12, // 36: coupon.Coupon.CreateMileStone:input_type -> coupon.CreateMileStoneRequest
	17, // 37: coupon.Coupon.ListMileStone:input_type -> coupon.ListMileStoneRequest
	19, // 38: coupon.Coupon.DeleteMileStone:input_type -> coupon.DeleteMileStoneRequest
	32, // 39: coupon.Coupon.CreateCoupon:input_type -> coupon.CreateCouponRequest
	34, // 40: coupon.Coupon.DeleteCoupon:input_type -> coupon.DeleteCouponRequest
	20, // 41: coupon.CouponInternal.ReserveCoupon:input_type -> coupon.ReserveCouponRequest
	21, // 42: coupon.CouponInternal.UnReserveCoupon:input_type -> coupon.UnReserveCouponRequest
	22, // 43: coupon.CouponInternal.ConfirmCouponUsage:input_type -> coupon.ConfirmCouponUsageRequest
	23, // 44: coupon.CouponInternal.AddPoint:input_type -> coupon.AddPointRequest
	25, // 45: coupon.Coupon.ListCouponForCustomer:output_type -> coupon.ListCouponForCustomerResponse
	27, // 46: coupon.Coupon.ListCouponForCms:output_type -> coupon.ListCouponForCmsResponse
	31, // 47: coupon.Coupon.ListCurrency:output_type -> coupon.ListCurrencyResponse
	14, // 48: coupon.Coupon.CreateMileStone:output_type -> coupon.CreateMileStoneResponse
	18, // 49: coupon.Coupon.ListMileStone:output_type -> coupon.ListMileStoneResponse
	37, // 50: coupon.Coupon.DeleteMileStone:output_type -> google.protobuf.Empty
	33, // 51: coupon.Coupon.CreateCoupon:output_type -> coupon.CreateCouponResponse
	37, // 52: coupon.Coupon.DeleteCoupon:output_type -> google.protobuf.Empty
	37, // 53: coupon.CouponInternal.ReserveCoupon:output_type -> google.protobuf.Empty
	37, // 54: coupon.CouponInternal.UnReserveCoupon:output_type -> google.protobuf.Empty
	37, // 55: coupon.CouponInternal.ConfirmCouponUsage:output_type -> google.protobuf.Empty
	37, // 56: coupon.CouponInternal.AddPoint:output_type -> google.protobuf.Empty
