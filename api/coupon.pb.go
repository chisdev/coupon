...
const file_coupon_api_coupon_proto_rawDesc = "" +
	"\n" +
	"\x17coupon/api/coupon.proto\x12\x06coupon\x1a\x17validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"O\n" +
	"\n" +
	"SortMethod\x12\x1b\n" +
	...
	"\bstore_id\x18\x05 \x01(\x04R\astoreId\x12(\n" +
	...
	"\x06Coupon\x12[\n" +
	"\tHealCheck\x12\x18.coupon.HealCheckRequest\x1a\x19.coupon.HealCheckResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/coupon/healcheckB&Z$github.com/chisdev/coupon/api;couponb\x06proto3"
...
var file_coupon_api_coupon_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_coupon_api_coupon_proto_goTypes = []any{
	...
	(*HealCheckRequest)(nil),      // 8: coupon.HealCheckRequest
	(*HealCheckResponse)(nil),     // 9: coupon.HealCheckResponse
...
var file_coupon_api_coupon_proto_depIdxs = []int32{
	...
	10, // 4: coupon.StoreCoupon.expired_at:type_name -> google.protobuf.Timestamp
	...
	8,  // 7: coupon.Coupon.HealCheck:input_type -> coupon.HealCheckRequest
	9,  // 8: coupon.Coupon.HealCheck:output_type -> coupon.HealCheckResponse
