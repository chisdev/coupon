...
func (_q *CurrencyQuery) QueryCoupons() *CouponQuery {
...
func (_q *CurrencyQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CurrencyQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *CurrencyQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CurrencyQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *CurrencyQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *CurrencyQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CurrencyQuery) WithCoupons(opts ...func(*CouponQuery)) *CurrencyQuery {
	query := (&CouponClient{config: _q.config}).Query()
...
func (_q *CurrencyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Currency, error) {
	...
	if query := _q.withCoupons; query != nil {
		if err := _q.loadCoupons(ctx, query, nodes,
			func(n *Currency) { n.Edges.Coupons = []*Coupon{} },
			func(n *Currency, e *Coupon) { n.Edges.Coupons = append(n.Edges.Coupons, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *CurrencyQuery) loadCoupons(ctx context.Context, query *CouponQuery, nodes []*Currency, init func(*Currency), assign func(*Currency, *Coupon)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(entcoupon.FieldCurrencyID)
	}
	query.Where(predicate.Coupon(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(currency.CouponsColumn), fks...))
	}))
...
func (_q *CurrencyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(currency.Table, currency.Columns, sqlgraph.NewFieldSpec(currency.FieldID, field.TypeUint64))
	_spec.From = _q.sql
...
func (_q *CurrencyQuery) ForUpdate(opts ...sql.LockOption) *CurrencyQuery {
...
func (_q *CurrencyQuery) ForShare(opts ...sql.LockOption) *CurrencyQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
