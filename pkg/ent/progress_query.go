...
func (_q *ProgressQuery) QueryMilestone() *MilestoneQuery {
...
func (_q *ProgressQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ProgressQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *ProgressQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ProgressQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *ProgressQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *ProgressQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ProgressQuery) WithMilestone(opts ...func(*MilestoneQuery)) *ProgressQuery {
	query := (&MilestoneClient{config: _q.config}).Query()
...
//		GroupBy(progress.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Progress.Query().
//		Select(progress.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *ProgressQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Progress, error) {
	...
	if query := _q.withMilestone; query != nil {
		if err := _q.loadMilestone(ctx, query, nodes, nil,
			func(n *Progress, e *Milestone) { n.Edges.Milestone = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ProgressQuery) loadMilestone(ctx context.Context, query *MilestoneQuery, nodes []*Progress, init func(*Progress), assign func(*Progress, *Milestone)) error {
	ids := make([]uint64, 0, len(nodes))
	nodeids := make(map[uint64][]*Progress)
	for i := range nodes {
...
func (_q *ProgressQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(progress.Table, progress.Columns, sqlgraph.NewFieldSpec(progress.FieldID, field.TypeUint64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withMilestone != nil {
			_spec.Node.AddColumnOnce(progress.FieldMilestoneID)
		}
	}
...
func (_q *ProgressQuery) ForUpdate(opts ...sql.LockOption) *ProgressQuery {
...
func (_q *ProgressQuery) ForShare(opts ...sql.LockOption) *ProgressQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *ProgressQuery) Modify(modifiers ...func(s *sql.Selector)) *ProgressSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ProgressSelect) Modify(modifiers ...func(s *sql.Selector)) *ProgressSelect {
