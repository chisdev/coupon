...
func (_q *MilestoneQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MilestoneQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *MilestoneQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MilestoneQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *MilestoneQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *MilestoneQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(milestone.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Milestone.Query().
//		Select(milestone.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *MilestoneQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(milestone.Table, milestone.Columns, sqlgraph.NewFieldSpec(milestone.FieldID, field.TypeUint64))
	_spec.From = _q.sql
...
func (_q *MilestoneQuery) ForUpdate(opts ...sql.LockOption) *MilestoneQuery {
...
func (_q *MilestoneQuery) ForShare(opts ...sql.LockOption) *MilestoneQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *MilestoneQuery) Modify(modifiers ...func(s *sql.Selector)) *MilestoneSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *MilestoneSelect) Modify(modifiers ...func(s *sql.Selector)) *MilestoneSelect {
